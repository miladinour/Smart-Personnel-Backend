...
public interface CategorieRepository extends JpaRepository<Categorie, Long> {
    Optional<Categorie> findByNomAndUser(@org.springframework.data.repository.query.Param("nom") String nom, @org.springframework.data.repository.query.Param("user") User user);
    
    boolean existsByNomIgnoreCaseAndUser(@org.springframework.data.repository.query.Param("nom") String nom, @org.springframework.data.repository.query.Param("user") User user);
